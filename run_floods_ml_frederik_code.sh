...
cd /sci/labs/efratmorin/lab_share/FloodsML/
...
./neuralhydrology/neuralhydrology/nh_run_scheduler.py train --directory /sci/labs/efratmorin/lab_share/FloodsML/config_files_dir --runs-per-gpu 1 --gpu-ids 0
