...
do
  echo "run number: $i"
  NCCL_P2P_DISABLE=1 python ./FloodML_train_test.py --model CNN_LSTM --dataset CARAVAN --optim Adam --num_epochs 30 --sequence_length_spatial 7 --limit_size_above_1000
  NCCL_P2P_DISABLE=1 python ./FloodML_train_test.py --model LSTM --dataset CARAVAN --optim Adam --num_epochs 30 --sequence_length_spatial 7 --limit_size_above_1000
