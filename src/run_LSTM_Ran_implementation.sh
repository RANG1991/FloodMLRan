...
do
  echo "run number: $i"
  NCCL_P2P_DISABLE=1 python ./FloodML_train_test.py --model LSTM --dataset CARAVAN --optim Adam --num_epochs 15 --sequence_length_spatial 7 --num_workers_data_loader 2 --create_new_files
