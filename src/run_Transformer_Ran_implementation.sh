...
do
  echo "run number: $i"
  NCCL_P2P_DISABLE=1 python ./FloodML_train_test.py --model Transformer_CNN --dataset CARAVAN --optim Adam --num_epochs 10 --sequence_length_spatial 7 --num_workers_data_loader 3 --use_all_static_attr --create_new_files --save_checkpoint
done
